...
echo ''
echo -e 'INSTALLING STRIDE NODE MONITORING'
...
cd $HOME
git clone https://github.com/Egozit/stride-monitoring.git >/dev/null 2>&1
...
#Stride monitoring variables template 
COS_BIN_NAME=$COS_BIN_NAME             # example: /root/go/bin/strided or /home/user/go/bin/strided
COS_PORT_RPC=$COS_PORT_RPC         # default: 26657
COS_VALOPER=$COS_VALOPER           # example: stridevaloper1234545636767376535673
