...
echo ''
echo -e 'INSTALLING SEI NODE MONITORING'
...
cd $HOME
git clone https://github.com/Egozit/sei-monitoring.git >/dev/null 2>&1
cd sei-monitoring
...
#Sei monitoring variables template 
COS_BIN_NAME=$COS_BIN_NAME             # example: /root/go/bin/seid or /home/user/go/bin/seid
COS_PORT_RPC=$COS_PORT_RPC         # default: 26657
COS_VALOPER=$COS_VALOPER           # example: seivaloper1234545636767376535673
